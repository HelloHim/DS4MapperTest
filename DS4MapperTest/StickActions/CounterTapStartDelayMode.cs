...
{
    /// <summary>
    /// Selects which representation of Counter Movement Release Press' Counter Tap Start
    /// Delay is authoritative for the visible UI and the runtime effective range. Mirrors
    /// CounterTapLengthMode's three representations (Fixed, percentage variance around a
    ...
    /// </summary>
    public enum CounterTapStartDelayMode
    {
        Fixed,
