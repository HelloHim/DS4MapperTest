...
{
    /// <summary>
    /// Selects which representation of Counter Movement Release Press' Counter Tap Length
    ...
    /// only which representation is shown and which one drives GetEffectiveCounterTapLengthRange.
    ...
    /// </summary>
    public enum CounterTapLengthMode
    {
        Fixed,
