...
namespace DS4MapperTest.StickActions
{
    ...
    /// Counter Press Start Delay. Used by both CounterMovementReleasePressProcessor (stick
    ...
    /// machines. Mirrors
    /// CounterPressLengthTiming's shape, but the start delay's own bounds start at 0 (a delay
    /// of zero is the common case) rather than the press length's 10ms floor, and new actions
    ...
    /// </summary>
    public sealed class CounterPressStartDelayTiming
    {
        ...
        private CounterPressStartDelayMode mode = CounterPressStartDelayMode.Fixed;
        public CounterPressStartDelayMode Mode
        {
            get => mode;
            set => mode = value;
        }
        ...
        // CounterPressLengthTiming's class doc for why synchronisation is never done inside a
        ...
        {
            if (mode == CounterPressStartDelayMode.Fixed)
            {
        ...
        /// priority order as CounterPressLengthTiming.BestFitFixedAndPercentage: exact match,
