...
namespace DS4MapperTest.StickActions
{
    ...
    public sealed class CounterPressLengthTiming
    {
        ...
        // New actions default to Time Variance (Range), which shows CS2's 78-90ms
        // window directly rather than the equivalent 84ms base and 7% variance.
        private CounterPressLengthMode mode = CounterPressLengthMode.MinimumAndMaximum;
