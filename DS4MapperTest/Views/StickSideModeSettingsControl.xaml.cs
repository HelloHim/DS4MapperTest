...
{
    public partial class StickSideModeSettingsControl : UserControl
    {
        public StickSideModeSettingsControl()
        {
            InitializeComponent();
        }
        ...
        private void ExtraAddExtraBindingMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            FaceBindingFuncKind? kind = tag switch
            {
                ...
                "SimultaneousPress" => FaceBindingFuncKind.SimultaneousPress,
